/*
  ...
  - You are about to drop the column `collectionAddr` on the `Event` table. All the data in the column will be lost.
...
INSERT INTO "new_Event" ("approveLink", "countOfRewardTokens", "created_at", "creatorID", "description", "finished_at", "id", "isSBT", "locationID", "name", "nftIpfsUrl", "registeredParticipants", "started_at", "statusId", "typeId", "updated_at", "urlCover") SELECT "approveLink", "countOfRewardTokens", "created_at", "creatorID", "description", "finished_at", "id", "isSBT", "locationID", "name", "nftIpfsUrl", "registeredParticipants", "started_at", "statusId", "typeId", "updated_at", "urlCover" FROM "Event";
DROP TABLE "Event";
